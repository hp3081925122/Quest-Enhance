...
public final class TableEditorScreen extends BaseScreen {
    ...
    private void drawSelection(
        ...
        IconHelper.renderIcon(selection_color, graphics, left, top, region.width(), border_width);
        IconHelper.renderIcon(selection_color, graphics, left, top + region.height() - border_width, region.width(), border_width);
        IconHelper.renderIcon(selection_color, graphics, left, top, border_width, region.height());
        IconHelper.renderIcon(selection_color, graphics, left + region.width() - border_width, top, border_width, region.height());
    }
